...
EPOCHS = 8
LR = 1e-4
RESULTS_SUB = os.path.join(RESULTS_FOLDER, 'convnext_tiny')
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        if acc > best_acc:
            torch.save(model.state_dict(), os.path.join(RESULTS_SUB, "best_convnext_tiny.pth"))
            best_acc = acc
